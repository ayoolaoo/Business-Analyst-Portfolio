...
**Goal:** Explore urinary and plasma biomarkers associated with pancreatic cancer and compare patterns across diagnosis groups and disease stages.

**Description:** Reproducible R analysis involving data cleaning, missing-value assessment, grouped summary statistics, and visualization of biomarker behavior across clinical subgroups.

**Skills:** Data Cleaning, Exploratory Data Analysis, Summary Statistics, Data Visualization, Reproducible Analysis.
